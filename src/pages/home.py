...
#df = pd.read_csv('C:/Users/Katinan AGOSSOU/Desktop/Pr_Nelly/src/data/train.csv')
...
df = pd.read_csv(r"C:/Users/Katinan AGOSSOU/Desktop/Pr_Nelly/src/data/cleaned-data.csv")
...
layout = html.Div([
    ...
    html.Div([
        ...
        generate_kpi("Most prominent category", most_common_category),
    ...
    # Graphique (histogramme ou pie chart)
    dcc.Graph(
        id='chart'
    ),
])
